...
var Game = {
    ...
    preload : function() {
        ...
        game.load.image('partyDude', 'assets/images/bodyPart.png');                 //TODO asset f�r einsammelbare personen hinzuf�gen
    ...
    update : function () {
        if (delay > 24) {
            ...
            var speed = 16; //TODO entfernen, nur f�r test hier
    ...
    catchPartyDude : function() {
        ...
        if (dist < 32) {
            ...
            //neues element vorne in der schlange einf�gen
